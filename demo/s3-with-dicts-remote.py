...
def parse_record(e):
    r = json.loads(e)
    # Works fine locally -- will blow up remotely.
    # return {'ProductName': r['ProductName'], 'ProductID': r['ProductID']}
    return {'ProductName': r['ProductName'], 'ProductID': r['ProductID']}, r['Price']
